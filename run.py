...
def driver_config(args):
    # options = webdriver.Chrome(executable_path='C:/Program Files/Google/Chrome/Application/chrome.exe')
    options = webdriver.ChromeOptions()
    if platform.system() == "Windows":
        # options.binary_location = "C:/Program Files/Google/Chrome/Application/chrome.exe"
        user_data_dir = "C:\\Users\\kanav\\AppData\\Local\\Google\\Chrome\\User Data"
...
def call_gemini_api(args, messages):
    ...
    while True:
        try:
            ...
            prompt_tokens = gemini_response.usage.prompt_tokens
            completion_tokens = gemini_response.usage.completion_tokens
            ...
            return prompt_tokens, completion_tokens, gpt_call_error, gemini_response
...
def main():
    ...
    for task_id in range(len(tasks)):
        ...
        while it < args.max_iter:
            ...
            # Call Gemini API
            prompt_tokens, completion_tokens, gpt_call_error, gemini_response = (
                call_gemini_api(args, messages)
            )
